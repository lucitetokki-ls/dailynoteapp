...
export function DailyImagePanel() {
  ...
  return (
    <div className="survey-card survey-card-strong relative flex h-full min-h-[18rem] overflow-hidden rounded-lg border border-zinc-200 bg-white p-3 shadow-sm sm:min-h-[24rem] xl:min-h-[28rem]">
      {hasImageError ? (
